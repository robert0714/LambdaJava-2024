...
public class SDKv2LambdaUtils {
   ...
   public static String createLambdaFunction(LambdaClient awsLambda ,String functionName ,String className ,String functionCode ) {
       try {
...
//           String functionCode = functionCode();
   ...
   protected static void waitForFunctionActive(LambdaClient awsLambda,String functionName) throws TimeoutException, InterruptedException {
